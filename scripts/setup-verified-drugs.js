  ...
  try {
    ...
    if (!manufacturer2) {
      manufacturer2 = await User.create({
        ...
        organizationId: 'MFG_PHUC_HUNG',
        organizationInfo: {
          name: 'Công ty TNHH Đông dược Phúc Hưng',
          license: 'LIC_PHUC_HUNG_001',
          type: 'pharmaceutical_company',
          description: 'Nhà sản xuất đông dược uy tín tại Hà Nội'
        },
        mustChangePassword: true
      });
    ...
    const verifiedDrugs = await Drug.create([
      {
        ...
        distribution: {
          ...
          currentLocation: {
            ...
            organizationName: manufacturer1.organizationInfo.name,
      ...
      },
      {
        ...
        distribution: {
          ...
          currentLocation: {
            ...
            organizationName: manufacturer2.organizationInfo.name,
